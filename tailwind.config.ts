...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'arc-reactor': 'var(--gradient-arc-reactor)',
        'iron-man': 'var(--gradient-iron-man)',
        'cosmic': 'var(--gradient-cosmic)',
        'stealth': 'var(--gradient-stealth)',
      },
      boxShadow: {
        'glow-arc': 'var(--glow-arc-reactor)',
        'glow-iron': 'var(--glow-iron-man)',
        'glow-gold': 'var(--glow-stark-gold)',
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      animation: {
        ...
        "arc-ring": "arc-ring 3s linear infinite",
